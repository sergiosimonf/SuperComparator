...
public class EroskiSaveProductHistoryUseCaseImpl implements EroskiSaveProductHistoryUseCase {
    ...
    @Override
    public ResponseEntity<EroskiProductHistoryItems> saveProductsHistory(EroskiProductHistoryItems eroskiProductHistory) {
        return eroskiService.saveProductsHistory(eroskiProductHistory);
    }
}